...
class OneBotAdapter(PlatformAdapter):
    ...
    支持 NapCat, go-cqhttp, Lagrange 等遵循 OneBot v11 协议的 QQ 机器人框架；兼容 WeChatBridge（优先协议端 avatar_url）。
    ...
    # --- WECHATBRIDGE_AVATAR_PATCH_V1 start ---
    @staticmethod
    ...
    # --- WECHATBRIDGE_AVATAR_PATCH_V1 end ---
